...
void widget_show_kala_customer::on_spinBox_valueChanged(int arg1)
{
    ...
    if(ind!=-1)
    {
        ...
        for (int i=0;i<customer::vec_cloths.size();i++)
        {
            if (id == customer::vec_cloths[i].get_id())
            {
                customer::vec_cloths[i].set_stock(arg1);
            }
        }
    }
    else
    {
        ...
        for (int i=0;i<customer::vec_sporting.size();i++)
        {
            if (id == customer::vec_sporting[i].get_id())
            {
                customer::vec_sporting[i].set_stock(arg1);
            }
        }
    }
    Global::save_article();
...
void widget_show_kala_customer::on_pushButton_change_clicked()
{
    ...
    if(ind!=-1)
    {
        ...
        for (int i=0;i<customer::vec_cloths.size();i++)
        {
            if (id == customer::vec_cloths[i].get_id())
            {
                customer::vec_cloths[i].setImage_File(file);
            }
        }
    }
    else
    {
        ...
        for (int i=0;i<customer::vec_sporting.size();i++)
        {
            if (id == customer::vec_sporting[i].get_id())
            {
                customer::vec_sporting[i].setImage_File(file);
            }
        }
    }
    Global::save_article();
...
void widget_show_kala_customer::on_lineEdit_price_editingFinished()
{
    ...
    if(ind!=-1)
    {
        ...
        for (int i=0;i<customer::vec_cloths.size();i++)
        {
            if (id == customer::vec_cloths[i].get_id())
            {
                customer::vec_cloths[i].set_Price(n);
            }
        }
    }
    else
    {
        ...
        for (int i=0;i<customer::vec_sporting.size();i++)
        {
            if (id == customer::vec_sporting[i].get_id())
            {
                customer::vec_sporting[i].set_Price(n);
            }
        }
    }
    Global::save_article();
